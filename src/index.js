...
fs.readFile(path, 'utf8', function (err,data) {
    ...
    console.log(`Output #1: ${graph.weightOfPath('A-B-C')}`);
    console.log(`Output #2: ${graph.weightOfPath('A-D')}`);
    console.log(`Output #3: ${graph.weightOfPath('A-D-C')}`);
    console.log(`Output #4: ${graph.weightOfPath('A-E-B-C-D')}`);
    console.log(`Output #5: ${graph.weightOfPath('A-E-D')}`);
